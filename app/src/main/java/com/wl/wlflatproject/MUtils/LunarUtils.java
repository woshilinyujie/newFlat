...
public class LunarUtils {
    ...
    public static String[] getLunar(String year, String month, String day) {
        ...
        Lunar1(sDObj);
        lunar[0] = Animals[sy];
        lunar[1] = cYear(getYear());
        lunar[2] = (getIsLeap() ? "闰" : "");
        lunar[3] = monthNong[getMonth()];
        lunar[4] = cDay(getDay());
        lunar[5] = cyclical(getYearCyl());
        lunar[6] = cyclical(getMonCyl());
        lunar[7] = cyclical(getDayCyl());
